...
namespace MWAPI.Input.Sending
{
    public static class KeyboardSender
    {
        ...
        public static void VirtualKeyUp(VirtualKeyCode keyCode)
        {
            ...
            up.Data.Keyboard.Flags = KeyboardFlag.KEYUP;
        ...
        /// </summary>
        /// <param name="keyCode">The VirtualKeyCode to press</param>
        public static void VirtualKeyPress(VirtualKeyCode keyCode)
        {
            var down = new INPUT();
            down.Type = (UInt32)InputType.KEYBOARD;
            down.Data.Keyboard = new KEYBDINPUT();
        ...
        public static void VirtualTextEntry(string text)
        {
            ...
            for (int x = 0; x < len; x++)
            {
                ...
                down.Data.Keyboard.Flags = KeyboardFlag.UNICODE;
                down.Data.Keyboard.Time = 0;
                down.Data.Keyboard.ExtraInfo = IntPtr.Zero;
                ...
                up.Data.Keyboard.Flags = KeyboardFlag.KEYUP | KeyboardFlag.UNICODE;
                up.Data.Keyboard.Time = 0;
                up.Data.Keyboard.ExtraInfo = IntPtr.Zero;
        ...
        public static void VirtualModifiedKeyStroke(VirtualKeyCode modifierKeyCode, VirtualKeyCode keyCode)
        {
            VirtualKeyDown(modifierKeyCode);
            VirtualKeyPress(keyCode);
            VirtualKeyUp(modifierKeyCode);
        }
        ...
        /// <param name="keyCode">The key to simulate</param>
        public static void VirtualModifiedKeyStroke(IEnumerable<VirtualKeyCode> modifierKeyCodes, VirtualKeyCode keyCode)
        {
            if (modifierKeyCodes != null) modifierKeyCodes.ToList().ForEach(x => VirtualKeyDown(x));
            VirtualKeyPress(keyCode);
            if (modifierKeyCodes != null) modifierKeyCodes.Reverse().ToList().ForEach(x => VirtualKeyUp(x));
        }
        ...
        public static void VirtualModifiedKeyStroke(VirtualKeyCode modifierKey, IEnumerable<VirtualKeyCode> keyCodes)
        {
            VirtualKeyDown(modifierKey);
            if (keyCodes != null) keyCodes.ToList().ForEach(x => VirtualKeyPress(x));
            VirtualKeyUp(modifierKey);
        }
        ...
        /// <param name="modifierKeyCodes">The list of modifier keys</param>
        /// <param name="keyCodes">The list of keys to simulate</param>
        public static void VirtualModifiedKeyStroke(IEnumerable<VirtualKeyCode> modifierKeyCodes, IEnumerable<VirtualKeyCode> keyCodes)
        {
            if (modifierKeyCodes != null) modifierKeyCodes.ToList().ForEach(x => VirtualKeyDown(x));
            if (keyCodes != null) keyCodes.ToList().ForEach(x => VirtualKeyPress(x));
            if (modifierKeyCodes != null) modifierKeyCodes.Reverse().ToList().ForEach(x => VirtualKeyUp(x));
        ...
        /// </summary>
        /// <param name="keyCode">The VirtualKeyCode to press</param>
        public static void HardwareKeyDown(ScanCode keyCode)
        {
            var down = new INPUT();
            down.Type = (UInt32)InputType.KEYBOARD;
            down.Data.Keyboard = new KEYBDINPUT();
            down.Data.Keyboard.Vk = 0;
            down.Data.Keyboard.Scan = (UInt16)((int)keyCode & 0xFF);
        ...
        /// Calls the Win32 SendInput method to simulate a Key UP.
        /// </summary>
        /// <param name="keyCode">The HardwareKeyCode to lift up</param>
        public static void HardwareKeyUp(ScanCode keyCode)
        {
            var up = new INPUT();
            up.Type = (UInt32)InputType.KEYBOARD;
            up.Data.Keyboard = new KEYBDINPUT();
        ...
        /// <param name="modifierKeyCodes">The list of modifier keys</param>
        /// <param name="keyCodes">The list of keys to simulate</param>
        public static void HardwareModifiedKeyStroke(IEnumerable<ScanCode> modifierKeyCodes, IEnumerable<ScanCode> keyCodes)
        {
            if (modifierKeyCodes != null) modifierKeyCodes.ToList().ForEach(x => HardwareKeyDown(x));
            if (keyCodes != null) keyCodes.ToList().ForEach(x => HardwareKeyPress(x));
            if (modifierKeyCodes != null) modifierKeyCodes.Reverse().ToList().ForEach(x => HardwareKeyUp(x));
